...
mariadb_object_t *get_mariadb_api()
{
    ...
    mariadb->dthread_connect       = mariadb_dthread_connect;
    mariadb->dthread_query         = mariadb_dthread_query;
    mariadb->dthread_get_row       = mariadb_dthread_get_row;
    mariadb->dthread_disconnect    = mariadb_dthread_disconnect;
    mariadb->dthread_get_fields    = mariadb_dthread_get_fields;
    mariadb->dthread_get_field_num = mariadb_dthread_get_field_num;
